...
import (
	...
	"github.com/operator-framework/operator-marketplace/pkg/client/clientset/scheme"
...
func (c *OperatorsV1Client) CatalogSourceConfigs(namespace string) CatalogSourceConfigInterface {
	return newCatalogSourceConfigs(c, namespace)
}

func (c *OperatorsV1Client) OperatorSources(namespace string) OperatorSourceInterface {
